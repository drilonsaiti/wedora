...
export function VenueElementModal({
    ...
    const [
        ...
        useState<VenueColorKey>(
            'gray'
        )

    /*
     * Reset custom form whenever the
     * modal is closed.
     */
    useEffect(() => {
        if (open) {
    ...
    const handlePresetClick = (
        preset:
        (typeof VENUE_PRESETS)[number]
    ) => {
        /*
         * Important:
         *
         * Store the stable default label,
         * NOT the translated UI label.
         *
         * StaticVenueElement translates
         * system labels based on element.type.
         */
        onCreate({
            type:
            preset.type,
