...
import { getWeddingStatus, WEDDING_STATUS_LABELS, WEDDING_STATUS_COLORS } from '@/lib/wedding-status'
            ...
            {weddings.length === 0 ? (
                ...
                <div className="space-y-3">
                    {weddings.map((w) => {
                        ...
                        return (
                            <div key={w.id} className="card-wedding p-5 flex items-center justify-between gap-4 hover:shadow-md transition-shadow">
                                <a href={`/admin/weddings/${w.id}`} className="flex items-center gap-4 flex-1 min-w-0">
                                    ...
                                    <div className="min-w-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className={`text-[10px] font-sans font-medium px-2 py-0.5 rounded-full shrink-0 ${WEDDING_STATUS_COLORS[status]}`}>
