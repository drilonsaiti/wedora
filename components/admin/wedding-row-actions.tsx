...
import { MoreVertical, Armchair, Images, Settings } from 'lucide-react'
...
export function WeddingRowActions({ weddingId }: { weddingId: string }) {
  ...
  return (
      <div className="relative">
        ...
        {open && (
            <div className="absolute right-0 top-full mt-1 w-48 bg-card border border-border rounded-xl shadow-lg overflow-hidden z-10">
              <Link
