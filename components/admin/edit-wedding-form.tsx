    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label className="font-sans text-xs uppercase tracking-widest text-muted-foreground block mb-2">Emri
                        i Dhëndrit</label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label className="font-sans text-xs uppercase tracking-widest text-muted-foreground block mb-2">Email
                        i Dhëndrit</label>
            ...
            <p className="text-[10px] text-muted-foreground -mt-3 italic">
                Ndryshimi i email-it këtu s&apos;e ndryshon email-in e llogarisë ekzistuese — kontaktoni suportin për
                atë.
            </p>

            <div>
                <label className="font-sans text-xs uppercase tracking-widest text-muted-foreground block mb-2">Data e
                    Dasmës</label>
                <input {...register('wedding_date')} type="date" className="input-wedding py-3 w-full"/>
            </div>

            <div>
                <label className="font-sans text-xs uppercase tracking-widest text-muted-foreground block mb-3">Ngjyra e
                    Temës</label>
            ...
            <div className="space-y-2">
                ...
                {errors.enable_find_seat &&
                    <p className="text-xs text-destructive">{errors.enable_find_seat.message}</p>}
            </div>
            ...
            <button type="submit" disabled={isSubmitting}
                ...
                {isSubmitting ? <Loader2 className="w-4 h-4 animate-spin"/> : saved ?
