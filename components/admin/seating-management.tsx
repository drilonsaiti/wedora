...
import { Guest, Table, GuestWithTable } from '@/types/seating'
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-card/95 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={async () => await signOutAction()} className="btn-ghost text-xs py-2 px-3 print:hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {initialTables.map(table => (
                <div key={table.id} className="card-wedding p-6 flex flex-col items-center text-center relative">
                  ...
                  <div className="w-20 h-20 rounded-full border-2 border-dashed border-[hsl(var(--gold))] flex flex-col items-center justify-center mb-4">
                  ...
                  <p className="font-sans text-xs text-muted-foreground mt-1">
                    {initialGuests.filter(g => g.table_id === table.id).length} / {table.seats} Vende të zëna
                  </p>
                </div>
              ))}
