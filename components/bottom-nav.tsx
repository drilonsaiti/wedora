        ...
        >
            <div className="mx-auto flex w-full items-center px-2 sm:px-2.5">
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className="max-w-full truncate text-[9px] font-medium uppercase tracking-[0.12em] sm:text-[9px]">
                  {item.label}
                </span>
                            </Link>
                        );
                ...
                <div className="ml-1 flex shrink-0 items-center border-l border-border/60 pl-2">
                    <ThemeToggle className="h-10 w-10 border-0 bg-transparent shadow-none hover:bg-secondary" />
                </div>
            </div>
        </nav>
    );
