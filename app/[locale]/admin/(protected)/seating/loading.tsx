        ...
        >
            ...
            <div className="mt-6 grid gap-5 xl:grid-cols-[340px_minmax(0,1fr)]">
                ...
                <section className="min-w-0">
                    <div className="card-wedding overflow-hidden">
                        {/* Designer toolbar */}
                        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border/60 px-4 py-3.5 sm:px-5">
                        ...
                        {/* Canvas */}
                        <div className="relative min-h-[520px] overflow-hidden bg-background sm:min-h-[620px] xl:min-h-[700px]">
