                ...
                <section className="px-4 pb-20 sm:px-6">
                    <div className="mx-auto max-w-7xl">
                        {photos.length > 0 ? (
                            ...
                            <div className="mx-auto flex min-h-[320px] max-w-md items-center justify-center text-center">
                        ...
                        <div className="relative z-10 flex min-h-0 flex-1 items-center justify-center px-3 pb-28 sm:px-14 sm:pb-32">
                            <div className="relative h-full w-full">
                                {currentPhoto.originalUrl ? (
                                    ...
                                    <div className="absolute left-1/2 top-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-3xl bg-white/5" />
                                )}
                            </div>
...
function GalleryImage({
    ...
    /*
     * This creates a subtle editorial rhythm while
     * preserving a predictable responsive grid.
     */
    const aspectRatio =
        index % 7 === 0
            ? 'aspect-[4/5]'
