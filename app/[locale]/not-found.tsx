            ...
            <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col">
                ...
                <div className="flex flex-1 items-center justify-center py-16 sm:py-24">
                    <div className="w-full max-w-xl text-center">
                        {/* 404 */}
                        <div
                            className="relative mx-auto mb-8 flex h-28 w-28 items-center justify-center rounded-[2rem] border border-border/70 bg-card/75 shadow-sm backdrop-blur">
                            <span className="font-serif text-5xl font-light tracking-[-0.05em] text-foreground">
                                404
                            </span>

                            <span
                                className="absolute -right-1.5 -top-1.5 h-4 w-4 rounded-full border-4 border-background bg-[hsl(var(--primary))]"/>
                        </div>
