...
export default async function CoupleForgotPasswordPage() {
    ...
    return (
        <main
            ...
            >
                <div
                    className="absolute left-1/2 top-[-240px] h-[620px] w-[760px] -translate-x-1/2 rounded-full bg-[hsl(var(--blush))]/30 blur-[140px]"/>

                <div
                    className="absolute bottom-[-240px] right-[-180px] h-[440px] w-[440px] rounded-full bg-[hsl(var(--gold))]/8 blur-[130px]"/>
            </div>
