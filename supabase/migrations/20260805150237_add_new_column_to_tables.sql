...
DROP POLICY IF EXISTS "admin_owns_wedding_table_seats" ON public.table_seats;
CREATE POLICY "admin_owns_wedding_table_seats" ON public.table_seats
...
CREATE POLICY "public_read_table_seats" ON public.table_seats
